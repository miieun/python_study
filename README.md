...
이 저장소는 Python 문법 학습뿐 아니라, QA 자동화 기초 역량을 쌓기 위한 학습 기록입니다.

특히 다음과 같은 점에서 QA 직무와 연결됩니다.

- 테스트 가능한 로직을 함수/클래스로 분리하는 연습
- pytest를 활용해 기대 결과를 검증하는 방식 학습
- 예외 상황(잘못된 타입, 0 나누기 등)에 대한 테스트 작성
- CSV 파일을 활용한 테스트 데이터 분리
- Selenium을 활용한 웹 UI 자동화 기초 실습
